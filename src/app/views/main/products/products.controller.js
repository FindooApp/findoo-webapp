angular.module('findoo').controller('ProductsController',function ($scope,$state,$rootScope){
    ...
    $rootScope.placeholder = "Search for Products...";
    $rootScope.search_select = "Products";
    var vm = this;
