angular.module('findoo').controller('ResourcesController',function ($scope,$state,$rootScope){
    ...
    $rootScope.placeholder = "Search for Resources...";
    $rootScope.search_select = "Resources";
    var vm = this;
