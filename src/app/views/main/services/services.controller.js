angular.module('findoo').controller('ServicesController',function ($scope,$state,$rootScope){
    ...
    $rootScope.placeholder = "Search for Services...";
    $rootScope.search_select = "Services";
    var vm = this;
