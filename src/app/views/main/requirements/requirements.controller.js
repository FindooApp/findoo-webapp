angular.module('findoo').controller('RequirementsController',function ($scope,$state,$rootScope){
    ...
    $rootScope.placeholder = "Search for Requirements...";
    $rootScope.search_select = "Requirements";
    var vm = this;
