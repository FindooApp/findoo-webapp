angular.module('findoo').controller('NotificationController',function ($scope,$state,$rootScope){
    ...
    $scope.postBox = function() {
        ...
        $scope.post_article = false;
        $scope.post_circular = false;
        $scope.post_announcement = false;
        $scope.post_call = false;
        $scope.post_script = false;
    ...
    $scope.postCircular = function() {
        $scope.show_add_form = true;
        $scope.post_status = false;
        $scope.post_article = false;
        $scope.post_circular = true;
        $scope.post_announcement = false;
        $scope.post_call = false;
        $scope.post_script = false;
        $scope.show_import_form = false;
